...
@Composable
private fun CatalogScreen(onDemoClick: (Route) -> Unit) {
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        DemoButton("Onboarding Tour") { onDemoClick(Route.Onboarding) }
        DemoButton("Feature Discovery") { onDemoClick(Route.FeatureDiscovery) }
        DemoButton("Interactive Tutorial") { onDemoClick(Route.InteractiveTutorial) }
        DemoButton("Multi-Target Spotlight") { onDemoClick(Route.MultiTarget) }
        DemoButton("Highlight Gallery") { onDemoClick(Route.HighlightGallery) }
        DemoButton("Theming Playground") { onDemoClick(Route.ThemingPlayground) }
        DemoButton("Analytics Dashboard") { onDemoClick(Route.AnalyticsDashboard) }
        DemoButton("Modal Tours") { onDemoClick(Route.ModalTours) }
    }
}
